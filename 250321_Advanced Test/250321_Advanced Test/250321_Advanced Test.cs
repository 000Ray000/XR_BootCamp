namespace _250321_Advanced_Test
{
    internal class Program
    {
        ...
        public static bool IsPrime(int number)
        {
            ...
            // 즉, 1로 나눴을 때 나머지가 0이고, 그 외에는 전부 나머지가 0이 아니다. 그게 소수.
        ...
        // 이 경우 0이 만약 요소라면, 0의 중복 여부는 어떻게 구분할 수 있을까?
        // 새로 만든 배열의 초기화값 0과, 내가 받아온 배열의 값들 간의 비교.
        // 아니면, 중복 판단 -> 카운트 1회 올리고 -> 배열에 넣기(그 중복한 수 만큼의 카운트를 배열의 길이로 가짐.)

        // 중복은 어떻게 해결할까? 
        // 중복도 그 공통 항목들끼리 비교해보고, 빼서 0이 되는 수가 있으면 한 쪽을 지워주면 된다. 
        // 다만, 그 값들의 수만큼 배열의 길이가 자동으로 줄어야 할텐데.
